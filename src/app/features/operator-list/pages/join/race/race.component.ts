...
import { concat, map, merge, race, range, take, zip } from 'rxjs';
...
export class RaceComponent extends AbstractOperatorPage {
  ...
  override ngOnInit(): void {
    this.sources[0].outputs.push(race(...this.sources[0].inputs));
  }
}
